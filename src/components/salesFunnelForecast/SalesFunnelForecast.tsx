...
import {setProbability} from "../../redux/probabilitySlice";

export const SalesFunnelForecast = () => {

    const dispatch = useDispatch()

    const checkProbability = (value: number) => dispatch(setProbability(value))
        ...
        <div className={'sales-funnel__container pt-4 col-12'}>
            ...
            <div className={'sales-funnel__diagram'}>
                <div className={'sales-funnel__stage'}>
                    ...
                    <Link to="/deals">
                        <svg
                            onClick={() => checkProbability(15)}
                            width="165" height="150" viewBox="0 0 165 150"
                ...
                <div className={'sales-funnel__stage'}>
                    ...
                    <Link to="/deals">
                        <svg
                            onClick={() => checkProbability(25)}
                            width="165" height="150" viewBox="0 0 165 150" xmlns="http://www.w3.org/2000/svg">
                            <path
